   ...
   */
        ...
        this.activatedRoute.queryParams.subscribe(function (params) {
            ...
            _this.authService.getCitaDetalleNC({ idCita: id })
                ...
                if (_this.paramId) {
                    _this.citaSeleccionada = _this.paramId;
                    _this.itemSelectedChange2({ idCita: _this.paramId });
                }
                else {
