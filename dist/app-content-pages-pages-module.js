...
var DetallecitaComponent = /** @class */ (function () {
    ...
    DetallecitaComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.queryParams.subscribe(function (params) {
            ...
            _this.authService.getCitaDetalleNC({ idCita: _this.selected, idCentro: _this.idCentro })
                .subscribe(function (data) {
                console.log(data);
                ...
                */
                _this.citaSeleccionada = data.citas.filter(function (word) { return word.idCita == _this.selected; })[0];
    ...
    HorarioComponent.prototype.guardarHS = function () {
        ...
        if (this.tiempoLibre.centroCerrado) {
            ...
            var dataEnv2 = { horaAbrir: null,
                horaCerrar: null,
                fecha: inicio, idCentro: this.idCentro, estado: 0
            };
            ...
            var dataEnv = { horaAbrir: this.tiempoLibre.horaAbrir, horaCerrar: this.tiempoLibre.horaCerrar,
                fecha: inicio, idCentro: this.idCentro, estado: 1
            };
            console.log(dataEnv);
