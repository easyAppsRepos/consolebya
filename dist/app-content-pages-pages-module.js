...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.ngOnInit = function () {
        ...
        this.infoFormGroup = this._formBuilder.group({
            telefonoNegocio: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].pattern(/^\d{7}$|^\d{8}$/)]],
    ...
    Object.defineProperty(RegisterComponent.prototype, "fs", {
        get: function () { return this.addFormGroup.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RegisterComponent.prototype, "ffg", {
        get: function () { return this.firstFormGroup.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RegisterComponent.prototype, "ifg", {
        get: function () { return this.infoFormGroup.controls; },
        enumerable: true,
        configurable: true
    });
...
/*!*****************************************************************************!*\
  !*** ./src/app/content/pages/components/calendario/calendario.component.ts ***!
  \*****************************************************************************/
/*! exports provided: CallbackPipe, ModalcalenComponent, CalendarioComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var DetallecitaComponent = /** @class */ (function () {
    ...
    DetallecitaComponent.prototype.completarCita = function () {
        var _this = this;
        ...
        this.authService.completasssrCita(datE)
            ...
            console.log(data);
            _this.loadingScreen = false;
            _this.paramId = _this.citaSeleccionada.idCita;
            _this.ngOnInit();
        }, function (err) {
            _this.loadingScreen = false;
            console.log('someError');
...
var HorarioComponent = /** @class */ (function () {
    ...
    HorarioComponent.prototype.setDate2 = function () {
        this.tiempoLibre.fin = this.tiempoLibre.inicio;
        this.getDatesBet();
    };
    HorarioComponent.prototype.getDatesBet = function () {
...
/*!*********************************************************************************!*\
  !*** ./src/app/content/pages/components/nuevareserva/nuevareserva.component.ts ***!
  \*********************************************************************************/
/*! exports provided: CallbackPipe, NuevareservaComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var NuevareservaComponent = /** @class */ (function () {
    function NuevareservaComponent(fb, ngZone, cdr, authService, _location, activatedRoute, router) {
        ...
        this.filterUser = function (user) {
            ...
            if (_this.idSubcategoriaS !== 0) {
                return user.idSubcategoria == _this.idSubcategoriaS;
            }
            else if (_this.idCategoriaS !== 0) {
                return user.idCategoria == _this.idCategoriaS;
            }
            else {
                return true;
            }
    ...
    NuevareservaComponent.prototype.getSubs = function (eve) {
        var _this = this;
        console.log(eve);
        this.idSubcategoriaS = 0;
...
/***/ "./src/app/content/pages/page.component.scss":
/*!***************************************************!*\
  !*** ./src/app/content/pages/page.component.scss ***!
  \***************************************************/
/*! no static exports found */
...
module.exports = ".topFix {\n  padding-top: 0px !important; }\n\n.topFix2 {\n  padding-top: 60px !important; }\n\n::ng-deep .m-aside-menu.m-aside-menu--skin-dark .m-menu__nav > .m-menu__item.m-menu__item--active > .m-menu__heading .m-menu__link-text, .m-aside-menu.m-aside-menu--skin-dark .m-menu__nav > .m-menu__item.m-menu__item--active > .m-menu__link .m-menu__link-text {\n  color: #e91e63; }\n"
...
var PagesComponent = /** @class */ (function () {
    ...
    PagesComponent.prototype.onResize = function (event) {
        this.screenHeight = window.innerHeight;
        this.screenWidth = window.innerWidth;
    };
    PagesComponent.prototype.ngOnInit = function () { };
    PagesComponent.prototype.getRealWidth = function () {
        //this.screenHeight = window.innerHeight;
    ...
    ], PagesComponent.prototype, "onResize", null);
    __decorate([
    ...
    PagesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./page.component.scss */ "./src/app/content/pages/page.component.scss")],
