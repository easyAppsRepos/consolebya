...
/* harmony import */ var _core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../core/auth/authentication.service */ "./src/app/core/auth/authentication.service.ts");
...
/* harmony import */ var _core_auth_auth_notice_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../core/auth/auth-notice.service */ "./src/app/core/auth/auth-notice.service.ts");
...
var Modal3Component = /** @class */ (function () {
    ...
    Modal3Component = __decorate([
        ...
        __metadata("design:paramtypes", [Object, _core_auth_auth_notice_service__WEBPACK_IMPORTED_MODULE_7__["AuthNoticeService"],
            _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"],
            _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialog"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]])
    ], Modal3Component);
...
var Modal4Component = /** @class */ (function () {
    function Modal4Component(data, dialog, translate, _formBuilder, cdr, authService, dialogRef) {
        ...
        this.firstFormGroupService = this._formBuilder.group({
            nombreServicio: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            precioServicio: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            categoriaServicio: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            subcategoriaServicio: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            horaServicio: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            minutoServicio: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required]
        });
    ...
    Modal4Component.prototype.verificarLenSer = function () {
        var len = this.empleados.filter(function (ep) { return ep.checked == true; }).length;
        console.log(len);
        return len;
    };
    ...
    Modal4Component = __decorate([
        ...
        __param(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Optional"])()), __param(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"])),
        __metadata("design:paramtypes", [Object, _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialog"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateService"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"],
            _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"]])
    ], Modal4Component);
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.ngOnInit = function () {
        ...
        this.firstFormGroup = this._formBuilder.group({
            ...
            accesoweb: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required]
        });
        this.addFormGroup = this._formBuilder.group({
            ...
            telefonoStaff: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
        ...
        this.infoFormGroup = this._formBuilder.group({
            telefonoNegocio: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            descripcion: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            webUsuario: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].pattern(reg)],
            latitud: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            longitud: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            direccion: [''],
        });
    };
    RegisterComponent.prototype.moveSt = function (index) {
    ...
    RegisterComponent.prototype.checkUsername = function (control) {
        ...
        return new Promise(function (resolve) {
            ...
            _this.authService.verificarEmail({ email: control.value })
                .subscribe(function (data) {
                if (data.length > 0) {
    ...
    RegisterComponent.prototype.ddddsss = function (ss) { console.log(ss); };
    ...
    RegisterComponent.prototype.goForward42 = function (stepper) {
        var _this = this;
        this.loadingScreen = true;
        if (this.urlImg2) {
            var uploadData = new FormData();
    ...
    RegisterComponent.prototype.onFileChanged2 = function (event) {
        var _this = this;
    ...
    RegisterComponent.prototype.goForward5 = function (stepper) {
        ...
        this.serviciosAgregados.forEach(function (item) {
            var datE = { idCentro: _this.centroId,
            ...
            _this.authService.addServicioNC(datE)
                .subscribe(function (data) {
                console.log(data);
            }, function (err) {
                _this.loadingScreen = false;
    ...
    RegisterComponent.prototype.getLen = function () {
        var _this = this;
    ...
    RegisterComponent.prototype.openDialogService = function () {
        ...
        */
        var _this = this;
        var dialogRefS = this.dialog.open(Modal4Component, { data: this.centroId });
    ...
    RegisterComponent.prototype.openDialog3 = function () {
        ...
        var sub = dialogRef.componentInstance.onAdd2.subscribe(function (data) {
            console.log(data);
            _this.cdr.detectChanges();
        });
    };
    ...
    RegisterComponent.prototype.validate = function (f) {
        ...
        this.errors = [];
        if (object_path__WEBPACK_IMPORTED_MODULE_6__["get"](f, 'form.controls.fullname.errors.required')) {
        ...
        if (object_path__WEBPACK_IMPORTED_MODULE_6__["get"](f, 'form.controls.rpassword.errors.required')) {
            this.errors.push(this.translate.instant('AUTH.VALIDATION.REQUIRED', { name: this.translate.instant('AUTH.INPUT.CONFIRM_PASSWORD') }));
        }
        if (object_path__WEBPACK_IMPORTED_MODULE_6__["get"](f, 'form.controls.agree.errors.required')) {
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__["NgbModal"],
            _core_auth_auth_notice_service__WEBPACK_IMPORTED_MODULE_7__["AuthNoticeService"],
            _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialog"],
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateService"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"],
            _agm_core__WEBPACK_IMPORTED_MODULE_10__["MapsAPILoader"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]])
    ], RegisterComponent);
        ...
        geocoder.geocode(request, function (results, status) {
            if (status === google.maps.GeocoderStatus.OK) {
                ...
                if (result != null) {
                    console.log(results);
                    console.log(result);
                    _this.dataCentro['direccion'] = result;
                    _this.searchElementRef.nativeElement.value = result;
                    _this.cdr.detectChanges();
                }
                else {
...
/***/ "./src/app/content/pages/components/addstaff/addstaff.component.html":
/*!***************************************************************************!*\
  !*** ./src/app/content/pages/components/addstaff/addstaff.component.html ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/addstaff/addstaff.component.scss":
/*!***************************************************************************!*\
  !*** ./src/app/content/pages/components/addstaff/addstaff.component.scss ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/addstaff/addstaff.component.ts":
/*!*************************************************************************!*\
  !*** ./src/app/content/pages/components/addstaff/addstaff.component.ts ***!
  \*************************************************************************/
...
var AddstaffComponent = /** @class */ (function () {
    function AddstaffComponent(router, _location, activatedRoute, subheaderService, authService, cdr, _formBuilder) {
        this.router = router;
    ...
    AddstaffComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'm-addstaff',
            template: __webpack_require__(/*! ./addstaff.component.html */ "./src/app/content/pages/components/addstaff/addstaff.component.html"),
            styles: [__webpack_require__(/*! ./addstaff.component.scss */ "./src/app/content/pages/components/addstaff/addstaff.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _core_services_layout_subheader_service__WEBPACK_IMPORTED_MODULE_2__["SubheaderService"],
            _core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
...
/*!***********************************************************************************!*\
  !*** ./src/app/content/pages/components/agregaroferta/agregaroferta.component.ts ***!
  \***********************************************************************************/
/*! exports provided: DialogOverviewExampleDialog, AgregarofertaComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var DialogOverviewExampleDialog = /** @class */ (function () {
    ...
    DialogOverviewExampleDialog.prototype.onYClick = function () {
...
var AgregarofertaComponent = /** @class */ (function () {
    function AgregarofertaComponent(_location, authService, cdr, dialog) {
        this._location = _location;
        this.authService = authService;
        this.cdr = cdr;
        this.dialog = dialog;
    ...
    //marcarEnOfertaNC
    AgregarofertaComponent.prototype.openDialog = function () {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            ...
            console.log(result);
            if (result == 1) {
                _this.macarcarOferta();
            }
        });
    };
    AgregarofertaComponent.prototype.macarcarOferta = function () {
        var _this = this;
    ...
    AgregarofertaComponent.prototype.OnChange = function ($event, i, item) {
    ...
    AgregarofertaComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_0__["Location"], _core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"],
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"]])
...
/***/ "./src/app/content/pages/components/agregaroferta/dialog-overview-example-dialog.html":
/*!********************************************************************************************!*\
  !*** ./src/app/content/pages/components/agregaroferta/dialog-overview-example-dialog.html ***!
  \********************************************************************************************/
/*! no static exports found */
...
module.exports = "<!-- <h1 mat-dialog-title>Hi {{data.name}}</h1> -->\n<div mat-dialog-content>\n  <p>  ¿Desea agregar 1 ofertas por $7 dólares?</p>\n  <!--<mat-form-field>\n     <input matInput [(ngModel)]=\"data.animal\">\n  </mat-form-field> -->\n</div>\n<div mat-dialog-actions>\n  <button mat-button (click)=\"onNoClick()\">Cancelar</button>\n  <button mat-button (click)=\"onYClick()\" cdkFocusInitial>Confirmar</button>\n</div>\n"

/***/ }),

/***/ "./src/app/content/pages/components/agregarpaquete/agregarpaquete.component.html":
/*!***************************************************************************************!*\
  !*** ./src/app/content/pages/components/agregarpaquete/agregarpaquete.component.html ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/agregarpaquete/agregarpaquete.component.scss":
/*!***************************************************************************************!*\
  !*** ./src/app/content/pages/components/agregarpaquete/agregarpaquete.component.scss ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/agregarpaquete/agregarpaquete.component.ts":
/*!*************************************************************************************!*\
  !*** ./src/app/content/pages/components/agregarpaquete/agregarpaquete.component.ts ***!
  \*************************************************************************************/
/*! exports provided: DialogOverviewExampleDialog2, AgregarpaqueteComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AgregarpaqueteComponent", function() { return AgregarpaqueteComponent; });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../core/auth/authentication.service */ "./src/app/core/auth/authentication.service.ts");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
...
var DialogOverviewExampleDialog2 = /** @class */ (function () {
    function DialogOverviewExampleDialog2(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    ...
    DialogOverviewExampleDialog2.prototype.onYClick = function () {
        this.dialogRef.close(1);
    };
...
var AgregarpaqueteComponent = /** @class */ (function () {
    function AgregarpaqueteComponent(_location, authService, cdr, dialog) {
        this._location = _location;
        this.authService = authService;
        this.cdr = cdr;
        this.dialog = dialog;
    ...
    AgregarpaqueteComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    //marcarEnOfertaNC
    AgregarpaqueteComponent.prototype.getHoras = function (hora) {
    ...
    AgregarpaqueteComponent.prototype.openDialog = function () {
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            ...
            if (result == 1) {
                //this.macarcarOferta();
                _this.loadingScreen = true;
                _this.cdr.detectChanges();
                var dataEnv = { duracion: _this.duracion.totalTiempo,
                    nombrePaquete: _this.duracion.nombre,
                    servicios: _this.itemsPaquete,
                    precio: _this.valorOferta,
                    idCentro: _this.idCentro };
                console.log(dataEnv);
                _this.macarcarOferta(dataEnv);
            }
        });
    };
    AgregarpaqueteComponent.prototype.macarcarOferta = function (daaata) {
        var _this = this;
    ...
    AgregarpaqueteComponent.prototype.goBack = function () {
        this._location.back();
        //	let _backUrl = 'servicios';
        //this.router.navigateByUrl(_backUrl);
    };
    AgregarpaqueteComponent.prototype.OnChange = function ($event, i, item) {
        //$event.checked ? (this.selected2=i) : (this.selected2=undefined);
        //this.valorOferta=undefined;
        ...
        if ($event.checked) {
            ...
            this.duracion.totalTiempo -= item.duracion;
            var index = this.itemsPaquete.map(function (x) {
                return x.idServicio;
            }).indexOf(i);
    ...
    AgregarpaqueteComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'm-agregarpaquete',
            template: __webpack_require__(/*! ./agregarpaquete.component.html */ "./src/app/content/pages/components/agregarpaquete/agregarpaquete.component.html"),
    ...
    return AgregarpaqueteComponent;
}());
...
/***/ "./src/app/content/pages/components/agregarpaquete/dialog-overview-example-dialog2.html":
/*!**********************************************************************************************!*\
  !*** ./src/app/content/pages/components/agregarpaquete/dialog-overview-example-dialog2.html ***!
  \**********************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/agregarservicio/agregarservicio.component.html":
/*!*****************************************************************************************!*\
  !*** ./src/app/content/pages/components/agregarservicio/agregarservicio.component.html ***!
  \*****************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/agregarservicio/agregarservicio.component.scss":
/*!*****************************************************************************************!*\
  !*** ./src/app/content/pages/components/agregarservicio/agregarservicio.component.scss ***!
  \*****************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/agregarservicio/agregarservicio.component.ts":
/*!***************************************************************************************!*\
  !*** ./src/app/content/pages/components/agregarservicio/agregarservicio.component.ts ***!
  \***************************************************************************************/
/*! exports provided: AgregarservicioComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AgregarservicioComponent", function() { return AgregarservicioComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _core_services_layout_subheader_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../core/services/layout/subheader.service */ "./src/app/core/services/layout/subheader.service.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
...
var AgregarservicioComponent = /** @class */ (function () {
    function AgregarservicioComponent(router, _location, activatedRoute, subheaderService, authService, cdr, _formBuilder) {
        var _this = this;
        this.router = router;
        this._location = _location;
        this.activatedRoute = activatedRoute;
        ...
        this.firstFormGroup = this._formBuilder.group({
            ...
            duracionH: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            duracionM: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            idCategoria: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required],
            idSubcategoria: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required]
        });
        this.authService.getCategorias()
            .subscribe(function (data) {
            _this.categorias = data;
    ...
    AgregarservicioComponent.prototype.ngOnInit = function () {
    };
    AgregarservicioComponent.prototype.getSubs = function (eve) {
        var _this = this;
        console.log(eve);
        this.authService.getSubcategorias({ idCategoria: eve.value })
            .subscribe(function (data) {
    ...
    AgregarservicioComponent.prototype.guardarServicio = function () {
        ...
        dataEnv.idCentro = this.idCentro;
        dataEnv.empleados = this.empleados.filter(function (word) { return word.checke == true; });
        console.log(dataEnv);
        //updateServicioNC
    ...
    AgregarservicioComponent.prototype.goBack = function () {
        this._location.back();
    };
    AgregarservicioComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'm-agregarservicio',
            template: __webpack_require__(/*! ./agregarservicio.component.html */ "./src/app/content/pages/components/agregarservicio/agregarservicio.component.html"),
            styles: [__webpack_require__(/*! ./agregarservicio.component.scss */ "./src/app/content/pages/components/agregarservicio/agregarservicio.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], _core_services_layout_subheader_service__WEBPACK_IMPORTED_MODULE_2__["SubheaderService"],
            _core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"]])
...
var CalendarioComponent = /** @class */ (function () {
    function CalendarioComponent(authService, cdr, dialog) {
        ...
        this.loadingScreen = false;
        this.info = [];
        this.horasCalen = [{ txt: '8 AM', val: '08' },
            { txt: '9 AM', val: '09' },
            { txt: '10 AM', val: '10' },
            { txt: '11 AM', val: '11' },
            { txt: '12 AM', val: '12' },
    ...
    CalendarioComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getStaff({ idCentro: this.idCentro })
            ...
            _this.loadingScreen = false;
            _this.empleados = data;
            _this.estadoFiltroEmpleados = data.map(function (item) {
    ...
    CalendarioComponent.prototype.moverFechas = function () {
        this.diasAdelante = [];
        ...
        for (var i = 1; i < 5; i++) {
            ...
            this.diasAdelante[i] = Object(_angular_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(date, 'yyyy/MM/dd', 'en');
        }
    ...
    CalendarioComponent.prototype.getIntS = function (st) {
        return parseInt(st) < 8;
    };
    CalendarioComponent.prototype.getIntS2 = function (st) {
        return parseInt(st) > 22;
    };
    CalendarioComponent.prototype.vistaDia = function () {
        this.tipoCalendario = 2;
        this.cdr.detectChanges();
        this.getCalendarioDia();
    };
    CalendarioComponent.prototype.vistaSemana = function () {
        this.tipoCalendario = 1;
        this.cdr.detectChanges();
        this.moverFechas();
    };
    CalendarioComponent.prototype.moverFechasAA = function (valueRow) {
        var date = new Date(this.dateSelected);
        if (valueRow == 1) {
            date.setDate(date.getDate() + 5);
            this.dateSelected = Object(_angular_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(date, 'yyyy/MM/dd', 'en');
        }
        if (valueRow == 2) {
            date.setDate(date.getDate() - 5);
            this.dateSelected = Object(_angular_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(date, 'yyyy/MM/dd', 'en');
    ...
    CalendarioComponent.prototype.moverFechasAA2 = function (valueRow) {
        var date = new Date(this.dateSelected);
        if (valueRow == 1) {
            date.setDate(date.getDate() + 1);
            this.dateSelected = Object(_angular_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(date, 'yyyy/MM/dd', 'en');
    ...
    CalendarioComponent.prototype.changeFilter = function (ev) {
        console.log(ev.value);
        console.log(this.estadoFiltro);
    };
    CalendarioComponent.prototype.changeFilter2 = function (ev) {
        console.log(ev.value);
        console.log(this.estadoFiltroEmpleados);
    };
    CalendarioComponent.prototype.filtroEstado = function (ev) {
        console.log(ev.source.value);
        console.log(ev.source.selected);
        console.log(this.estadoFiltro);
    };
    CalendarioComponent.prototype.aplicarFiltros = function (estado) {
        return this.estadoFiltro.includes(estado);
    };
    CalendarioComponent.prototype.getKeys = function (item) {
        // console.log(item);
        var result = this.dataTotal.filter(function (word) { return word.fechaServicio == item; }).length;
        return result;
    };
    CalendarioComponent.prototype.getKeys2 = function (item) {
        //console.log(item);
        var result = this.dataTotal.filter(function (word) { return word.idEmpleado == item; }).length;
        return result;
    };
    CalendarioComponent.prototype.aplicarFiltros2 = function (dd) {
        return this.estadoFiltroEmpleados.includes((Object.values(dd)[0][0].idEmpleado));
    };
    CalendarioComponent.prototype.aplicarFiltros3 = function (dd) {
        return this.estadoFiltroEmpleados.includes(dd);
    };
    CalendarioComponent.prototype.showSome2 = function (dd) {
        return (Object.values(dd)[0][0].empleadoFoto);
    };
    CalendarioComponent.prototype.showSome = function (dd) {
        return (Object.values(dd)[0][0].nombreEmpleado);
    };
    CalendarioComponent.prototype.getValues = function (item) {
        return item;
    };
    //getCalendarioNC
    CalendarioComponent.prototype.getCalendarioDia = function () {
        var _this = this;
        this.loadingScreen = true;
    ...
    CalendarioComponent.prototype.getCitasCalendario = function () {
        var _this = this;
        this.loadingScreen = true;
    ...
    CalendarioComponent.prototype.changeCalen = function (fecha) {
        this.dateSelected = Object(_angular_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(fecha, 'yyyy/MM/dd', 'en');
        this.moverFechas();
    };
    CalendarioComponent.prototype.openDialogCita = function (item) {
...
/***/ "./src/app/content/pages/components/configuracion/configuracion.component.html":
/*!*************************************************************************************!*\
  !*** ./src/app/content/pages/components/configuracion/configuracion.component.html ***!
  \*************************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"row  m-subheader\" style=\"background: rgb(250,249,247) !important;\r\n    padding: 20px !important;\r\ntext-align: left !important;\r\nborder-bottom: solid 1px lightgray;    display: block;\">\r\n\t\r\n\t<div class=\"\" style=\"display: inline-block;font-size: 30px;font-weight: 300;padding-left: 30px;\">Configuracion</div>\r\n\r\n\t<button  class=\"btn btn-success\" style=\"    margin-top: 3px;\r\n    float: right;\r\n    margin-right: 10px;\" [disabled]='\r\n    !configuracion.parametro1 || !configuracion.parametro2 || !configuracion.parametro3' (click)='editarConf()'>Guardar</button>\r\n\r\n\r\n\r\n</div>\r\n\r\n\r\n<div class=\"row\" style=\"    padding: 40px;\">\r\n\r\n <ngx-loading [show]=\"loadingScreen\" [config]=\"{ backdropBorderRadius: '14px' }\"></ngx-loading>\r\n\r\n\t\r\n\t<div class=\"col-sm-12\">\r\n\r\n\r\n    <div style='max-width: 600px;\r\n    margin: auto;'>\r\n\r\n\r\n    <div style=\"text-align: center;  padding: 40px;padding-top: 50px !important\">\r\n      <span style=\"color: #383734;    font-size: 24px;\r\n    font-weight: 300;\r\n    line-height: 34px;\r\n    margin-bottom: 10px;\">Configuracion de Citas\r\n\r\n</span><br>\r\n<span style=\"color: #605f5d;font-size: 16px\">\r\nAjusta los valores para la configuracion de tus citas\r\n</span>\r\n\r\n    </div>\r\n\r\n\r\n\r\n \r\n    <div style=\"    padding: 0px 0px 20px 0px;\">\r\n<!--     <mat-slide-toggle [(ngModel)]=\"isHuman2\" (change)=\"onChange2($event)\" name=\"human2\">I am not a robot</mat-slide-toggle> -->\r\n\r\n    <mat-slide-toggle color='primary' name=\"human2\"  [(ngModel)]='configuracion.confirmacionAutomatica'>\r\n      <span style=\"font-size: 16px !important;\">\r\n        Las citas serán confirmadas automaticamente\r\n      </span>\r\n      </mat-slide-toggle>\r\n\r\n\r\n    </div>\r\n\r\n    <hr>\r\n\r\n    <div style=\"color: #383734;font-size: 19px;font-weight: 400; line-height: 34px;margin-bottom: 30px;\">Configuraciones de cita</div>\r\n\r\n      <p style=\"display: inline-block;font-size: 16px;\">Los clientes podrán realizar citas</p>\r\n      <mat-select placeholder=\"\" \r\n      class='inputBy selectD' style='border: solid 1px #e1e1e1;padding: 5px;' \r\n      [(ngModel)]='configuracion.parametro1'>\r\n                <mat-option [value]=\"1\">Hasta 1 hora antes de la hora de inicio</mat-option>\r\n                 <mat-option [value]=\"2\">Hasta 2 horas antes de la hora de inicio</mat-option>\r\n           <mat-option [value]=\"3\">Hasta 3 horas antes de la hora de inicio</mat-option>\r\n            <mat-option [value]=\"6\">Hasta 6 horas antes de la hora de inicio</mat-option>\r\n             <mat-option [value]=\"12\">Hasta 12 horas antes de la hora de inicio</mat-option>\r\n\r\n      </mat-select>\r\n\r\n\r\n\r\n      <p style=\"display: inline-block;font-size: 16px;\">Los clientes podrán realizar citas</p>\r\n      <mat-select placeholder=\"\" class='inputBy selectD' \r\n       [(ngModel)]='configuracion.parametro2'>\r\n                  <mat-option [value]=\"1\">Hasta 1 mes en el futuro</mat-option>\r\n                 <mat-option [value]=\"3\">Hasta 3 meses en el futuro</mat-option>\r\n                 <mat-option [value]=\"6\">Hasta 6 meses en el futuro</mat-option>\r\n                 <mat-option [value]=\"12\">Hasta 12 meses en el futuro</mat-option>\r\n      </mat-select>\r\n\r\n\r\n\r\n            <p style=\"display: inline-block;font-size: 16px;\">Permitir Reprogramaciones</p>\r\n      <mat-select placeholder=\"\" class='inputBy selectD' \r\n       [(ngModel)]='configuracion.parametro3'>\r\n                <mat-option [value]=\"12\">Hasta 12 horas antes de la cita</mat-option>\r\n                  <mat-option [value]=\"24\">Hasta 24 horas antes de la cita</mat-option>\r\n          \r\n\r\n      </mat-select>\r\n\r\n\r\n\r\n\r\n</div>\r\n\t</div>\r\n</div>"

/***/ }),

/***/ "./src/app/content/pages/components/configuracion/configuracion.component.scss":
/*!*************************************************************************************!*\
  !*** ./src/app/content/pages/components/configuracion/configuracion.component.scss ***!
  \*************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/configuracion/configuracion.component.ts":
/*!***********************************************************************************!*\
  !*** ./src/app/content/pages/components/configuracion/configuracion.component.ts ***!
  \***********************************************************************************/
...
var ConfiguracionComponent = /** @class */ (function () {
    function ConfiguracionComponent(authService, cdr, _location) {
        this.authService = authService;
        this.cdr = cdr;
        this._location = _location;
        this.loadingScreen = false;
    ...
    ConfiguracionComponent.prototype.editarConf = function () {
        var _this = this;
        this.loadingScreen = true;
    ...
    ConfiguracionComponent.prototype.goBack = function () {
        this._location.back();
        //	let _backUrl = 'servicios';
        //this.router.navigateByUrl(_backUrl);
    };
    ConfiguracionComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./configuracion.component.html */ "./src/app/content/pages/components/configuracion/configuracion.component.html"),
            styles: [__webpack_require__(/*! ./configuracion.component.scss */ "./src/app/content/pages/components/configuracion/configuracion.component.scss")]
        }),
        __metadata("design:paramtypes", [_core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"],
...
var DetallecitaComponent = /** @class */ (function () {
    function DetallecitaComponent(authService, cdr, _location, activatedRoute, router) {
        this.authService = authService;
        this.cdr = cdr;
        this._location = _location;
        this.activatedRoute = activatedRoute;
   ...
   */
        ...
        this.activatedRoute.queryParams.subscribe(function (params) {
            ...
            console.log(id);
            if (_this.paramId) {
                _this.selected = _this.paramId;
            }
            else {
                _this.selected = id;
            }
            _this.authService.getCitaDetalleNC({ idCita: id })
                .subscribe(function (data) {
                console.log(data);
                _this.serviciosCita = data.serviciosCita;
                if (_this.paramId) {
                    // this.citaSeleccionada=this.paramId;
                    _this.citaSeleccionada = data.citas.filter(function (word) { return word.idCita == _this.paramId; })[0];
                    _this.itemSelectedChange2(_this.citaSeleccionada);
                }
                else {
                    _this.citaSeleccionada = data.citas.filter(function (word) { return word.idCita == id; })[0];
                }
                //console.log(this.citaSeleccionada);
                _this.citasCliente = data.citas;
                _this.clienteInfo = data.infoCli[0];
                if (data.infoCli[0].idCentro !== _this.idCentro) {
    ...
    DetallecitaComponent.prototype.getHoras = function (hora) {
        return Math.floor(hora / 60);
    };
    DetallecitaComponent.prototype.cambiarEstado = function (cita, estadoX) {
        var _this = this;
        this.loadingScreen = true;
    ...
    DetallecitaComponent.prototype.itemSelectedChange2 = function (i) {
        var _this = this;
        ...
        this.authService.serviciosCitaNC({ idCita: i.idCita })
            .subscribe(function (data) {
            console.log(data);
            _this.serviciosCita = data.servicios;
            _this.loadingScreen = false;
            _this.cdr.detectChanges();
        }, function (err) {
            _this.loadingScreen = false;
    ...
    DetallecitaComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"],
...
var EditservicioComponent = /** @class */ (function () {
    function EditservicioComponent(router, _location, activatedRoute, subheaderService, authService, cdr, _formBuilder) {
        var _this = this;
        this.router = router;
        this._location = _location;
        this.activatedRoute = activatedRoute;
    ...
    EditservicioComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.queryParams.subscribe(function (params) {
            ...
            console.log(id);
            if (id && id > 0) {
                _this.authService.getServicioNC({ idServicio: id, idCentro: _this.idCentro })
                    .subscribe(function (data) {
                    console.log(data);
                    _this.servicio = data.servicio[0];
                    _this.empleados = data.empleados;
                    _this.servicio.duracionH = (Math.floor(_this.servicio.duracion / 60)) * 60;
                    _this.servicio.duracionM = _this.servicio.duracion % 60;
                    _this.getSubs2(_this.servicio.idCategoria);
                    _this.cdr.detectChanges();
                    //console.log(data);
                }, function (err) {
                    console.log('someError');
    ...
    EditservicioComponent.prototype.getSubs = function (eve) {
        var _this = this;
        console.log(eve);
        //this.categoriaName = (eve.source.selected._element.nativeElement.innerText.trim());
        this.authService.getSubcategorias({ idCategoria: eve.value })
            .subscribe(function (data) {
            _this.subcategorias = data;
            _this.servicio.idSubcategoria = undefined;
            console.log(data);
        }, function (err) {
            console.log('someError');
            alert('Ups! Algo ha salido mal');
    ...
    EditservicioComponent.prototype.eliminarServicio = function () {
        var _this = this;
        this.loadingScreen = true;
    ...
    EditservicioComponent.prototype.editarServicio = function () {
        var _this = this;
        this.loadingScreen = true;
    ...
    EditservicioComponent.prototype.getSubs2 = function (id) {
        var _this = this;
...
var EditstaffComponent = /** @class */ (function () {
    function EditstaffComponent(router, _location, activatedRoute, subheaderService, authService, cdr, _formBuilder) {
        this.router = router;
        this._location = _location;
        this.activatedRoute = activatedRoute;
        this.subheaderService = subheaderService;
    ...
    EditstaffComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.queryParams.subscribe(function (params) {
            console.log(params);
            _this.empleado2 = params;
            _this.empleado.nombre = _this.empleado2.nombre;
            _this.empleado.telefono = _this.empleado2.telefono;
            _this.empleado.email = _this.empleado2.email;
            _this.empleado.descripcion = _this.empleado2.descripcion;
            _this.empleado.tipo = _this.empleado2.tipo;
            _this.empleado.idFoto = _this.empleado2.idFoto;
            _this.empleado.idEmpleado = _this.empleado2.idEmpleado;
        });
    };
    EditstaffComponent.prototype.guardarStaff = function () {
        var _this = this;
        this.loadingScreen = true;
    ...
    EditstaffComponent.prototype.borrarStaff = function () {
        var _this = this;
...
var EstadisticaComponent = /** @class */ (function () {
    function EstadisticaComponent(authService, cdr) {
        this.authService = authService;
        this.cdr = cdr;
        this.loadingScreen = false;
        this.info = [];
    ...
    EstadisticaComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getInfoCentro({ idCentro: this.idCentro })
            ...
            _this.loadingScreen = false;
            console.log(data);
            _this.info = data.info[0];
            _this.ingresos = data.dataV[0];
            _this.bests = data.clientes;
            _this.cdr.detectChanges();
        }, function (err) {
            _this.loadingScreen = false;
            console.log('someError');
...
var HorarioComponent = /** @class */ (function () {
    function HorarioComponent(authService, cdr) {
        this.authService = authService;
        this.cdr = cdr;
        this.horarioHoras = [
            { 'text': '12:00 AM', 'valor': '00:00:00' },
    ...
    HorarioComponent.prototype.borrarBloque = function (id) {
        var _this = this;
        this.loadingScreen = true;
    ...
    HorarioComponent.prototype.guardarHorario = function () {
        var _this = this;
        this.loadingScreen = true;
...
/***/ "./src/app/content/pages/components/nuevareserva/nuevareserva.component.html":
/*!***********************************************************************************!*\
  !*** ./src/app/content/pages/components/nuevareserva/nuevareserva.component.html ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/nuevareserva/nuevareserva.component.scss":
/*!***********************************************************************************!*\
  !*** ./src/app/content/pages/components/nuevareserva/nuevareserva.component.scss ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/nuevareserva/nuevareserva.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/content/pages/components/nuevareserva/nuevareserva.component.ts ***!
  \*********************************************************************************/
/*! exports provided: NuevareservaComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NuevareservaComponent", function() { return NuevareservaComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var NuevareservaComponent = /** @class */ (function () {
    function NuevareservaComponent(fb, ngZone, cdr, authService, _location, activatedRoute, router) {
        var _this = this;
        this.fb = fb;
        this.ngZone = ngZone;
        this.cdr = cdr;
        ...
        this.myFilter = function (d) {
            ...
            var elemento = _this.horarioCentro.find(function (element) {
    ...
    NuevareservaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getCentroServicios2({ idCentro: this.idCentro })
            .subscribe(function (data) {
            _this.loadingScreen = false;
            _this.horarioCentro = data.horario;
        ...
        */
        /*
                this.loadingScreen = true;
                this.authService.getStaffBasicNC({idEmpleado:id})
              .subscribe((data:any) => {
        
                    this.loadingScreen = false;
                    this.empleadoInfo = data[0];
                  this.cdr.detectChanges();
                     console.log(data);
                },err => {
                      this.loadingScreen = false;
    ...
    NuevareservaComponent.prototype.getHoras = function (hora) {
        return Math.floor(hora / 60);
    };
    NuevareservaComponent.prototype.addServicio = function (item) {
        var found = this.serviciosCentro.find(function (element) {
    ...
    NuevareservaComponent.prototype.quitarItem = function (ind) {
        this.serviciosCita.splice(ind, 1);
        this.cdr.detectChanges();
        this.procesarData();
    };
    NuevareservaComponent.prototype.getMinH = function () {
        ...
        if (this.horarioCentro.find(function (x) { return x.diaSemana == dia; })) {
            ...
            horarioFix = this.horarioCentro.find(function (x) { return x.diaSemana == dia; }).horaAbrir;
        }
        return horarioFix;
    };
    NuevareservaComponent.prototype.getMaxH = function () {
        var horarioFix = '00:00';
        var d = new Date(this.cita.fecha);
        var dia = d.getDay();
        if (this.horarioCentro.find(function (x) { return x.diaSemana == dia; })) {
    ...
    NuevareservaComponent.prototype.moveDate = function (date) {
        console.log(date);
        this.procesarData();
    };
    NuevareservaComponent.prototype.guardarCita = function () {
        var _this = this;
        //precioFinal
        ...
        console.log(dataE);
        this.loadingScreen = true;
        this.authService.addCita(dataE)
            .subscribe(function (data) {
            _this.loadingScreen = false;
            console.log(data);
            _this.cdr.detectChanges();
    ...
    NuevareservaComponent.prototype.goBack = function () {
        this._location.back();
        //	let _backUrl = 'servicios';
        //this.router.navigateByUrl(_backUrl);
    };
    NuevareservaComponent.prototype.sinEmpleado = function () {
        var sinEmpleado = false;
        if (this.serviciosCita.length < 1) {
            sinEmpleado = true;
        }
    ...
    NuevareservaComponent.prototype.getTotal = function () {
        var total = 0;
        this.serviciosCita.forEach(function (item) {
    ...
    NuevareservaComponent.prototype.procesarData = function (tiemp) {
        if (tiemp === void 0) { tiemp = null; }
        return __awaiter(this, void 0, void 0, function () {
            var valueE, value, darr, indexx, d, diaS, fechaSeleccionada, _i, _a, item, dataEmpleados;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.cita.fecha) return [3 /*break*/, 7];
                        valueE = [];
                        value = [];
                        //this.serviciosCita = [];
                        this.serviciosCita = this.serviciosCita.map(function (x) {
                            delete x.empleados;
                        ...
                        darr = {};
                        indexx = 0;
                        d = new Date(this.cita.fecha);
                        diaS = d.getDay();
                        fechaSeleccionada = this.cita.fecha.getFullYear() + '-' + ('0' + (this.cita.fecha.getMonth() + 1)).slice(-2) + '-' + ('0' + this.cita.fecha.getDate()).slice(-2);
    ...
    NuevareservaComponent.prototype.getHorasFormat = function (dat) {
        var ww = Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(dat, 'h:mm a', 'es');
        return ww;
    };
    NuevareservaComponent.prototype.getHorasFormat2 = function (dat) {
        //console.log(dat);
        var dat2 = this.fechaSeleccionadaN + ' ' + dat;
        var ww = Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(dat2, 'h:mm a', 'es');
        return ww;
    };
    NuevareservaComponent.prototype.changeTime = function (time) {
        console.log(time);
        var tiempo = time.value.split(' ')[1];
        this.procesarData(tiempo);
    };
    NuevareservaComponent.prototype.delayedLog = function (item) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.authService.getHorasDispo(item).subscribe(function (data) {
                //  console.log(data);
                resolve(data);
            });
        });
    };
    NuevareservaComponent.prototype.delayedLog2 = function (item) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.authService.getEmpleadosDisponibles(item).subscribe(function (data) {
                //   console.log(data);
                resolve(data);
            });
        });
    };
    NuevareservaComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'm-nuevareserva',
            template: __webpack_require__(/*! ./nuevareserva.component.html */ "./src/app/content/pages/components/nuevareserva/nuevareserva.component.html"),
            styles: [__webpack_require__(/*! ./nuevareserva.component.scss */ "./src/app/content/pages/components/nuevareserva/nuevareserva.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["Location"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], NuevareservaComponent);
    return NuevareservaComponent;
}());
...
/* harmony import */ var _core_services_layout_subheader_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../core/services/layout/subheader.service */ "./src/app/core/services/layout/subheader.service.ts");
...
var PerfilnegocioComponent = /** @class */ (function () {
    //asd
    function PerfilnegocioComponent(router, _location, activatedRoute, subheaderService, fb, mapsAPILoader, ngZone, cdr, authService) {
        this.router = router;
        this._location = _location;
        this.activatedRoute = activatedRoute;
        this.subheaderService = subheaderService;
    ...
    PerfilnegocioComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getCentroInfoNC({ idCentro: this.idCentro })
            .subscribe(function (data) {
            _this.loadingScreen = false;
            _this.centroInfo = data[0];
            _this.markers[0] = {
                lat: _this.centroInfo.latitud,
                lng: _this.centroInfo.longitud,
                label: 'Ubicacion',
                draggable: true
            };
            _this.cdr.detectChanges();
        ...
        this.mapsAPILoader.load().then(function () {
            ...
            autocomplete.addListener("place_changed", function () {
                ...
                _this.centroInfo.latitud = place.geometry.location.lat();
                _this.centroInfo.longitud = place.geometry.location.lng();
                _this.centroInfo.direccion = place.formatted_address;
                _this.markers[0] = {
                    lat: _this.centroInfo.latitud,
                    lng: _this.centroInfo.longitud,
    ...
    PerfilnegocioComponent.prototype.editarCentroInfo = function () {
        var _this = this;
        this.loadingScreen = true;
    ...
    PerfilnegocioComponent.prototype.onFileChanged = function (event) {
        var _this = this;
        this.loadingScreen = true;
        this.selectedFile = event.target.files[0];
        var uploadData = new FormData();
    ...
    PerfilnegocioComponent.prototype.onFileChanged2 = function (event) {
        var _this = this;
        this.loadingScreen = true;
        this.selectedFile2 = event.target.files[0];
        var uploadData = new FormData();
        ...
        geocoder.geocode(request, function (results, status) {
            if (status === google.maps.GeocoderStatus.OK) {
                ...
                if (result != null) {
                    console.log(results);
                    console.log(result);
                    _this.centroInfo['direccion'] = result;
                    _this.cdr.detectChanges();
                }
                else {
                    //alert('No address available!');
...
/***/ "./src/app/content/pages/components/reprogramacion/reprogramacion.component.html":
/*!***************************************************************************************!*\
  !*** ./src/app/content/pages/components/reprogramacion/reprogramacion.component.html ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/reprogramacion/reprogramacion.component.scss":
/*!***************************************************************************************!*\
  !*** ./src/app/content/pages/components/reprogramacion/reprogramacion.component.scss ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/content/pages/components/reprogramacion/reprogramacion.component.ts":
/*!*************************************************************************************!*\
  !*** ./src/app/content/pages/components/reprogramacion/reprogramacion.component.ts ***!
  \*************************************************************************************/
/*! exports provided: ReprogramacionComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReprogramacionComponent", function() { return ReprogramacionComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var ReprogramacionComponent = /** @class */ (function () {
    function ReprogramacionComponent(fb, ngZone, cdr, authService, _location, activatedRoute, router) {
        var _this = this;
        this.fb = fb;
        this.ngZone = ngZone;
        this.cdr = cdr;
    ...
    ReprogramacionComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.activatedRoute.queryParams.subscribe(function (params) {
            console.log(params);
            _this.loadingScreen = true;
            _this.authService.getDataCita({ idCita: params.id })
                .subscribe(function (data) {
                _this.loadingScreen = false;
                _this.datasCita = data.cita[0];
                _this.horarioCentro = data.horario;
                _this.fechaSeleccionadaN = _this.datasCita.horaInicio.split('T')[0];
                _this.serviciosCita = data.servicios.map(function (item) {
    ...
    ReprogramacionComponent.prototype.getHoras = function (hora) {
        return Math.floor(hora / 60);
    };
    ReprogramacionComponent.prototype.addServicio = function (item) {
        var found = this.serviciosCentro.find(function (element) {
            return element.idServicio == item;
        });
        /*
    ...
    ReprogramacionComponent.prototype.quitarItem = function (ind) {
        this.serviciosCita.splice(ind, 1);
        this.cdr.detectChanges();
        this.procesarData();
    };
    ...
    ReprogramacionComponent.prototype.moveDate = function (date) {
        console.log(date);
        this.procesarData();
    };
    ReprogramacionComponent.prototype.guardarCita = function () {
        //precioFinal
        /*
          var fechaSeleccionada = this.cita.fecha.getFullYear()+'-'+('0' + (this.cita.fecha.getMonth()+1)).slice(-2)+'-'+('0' + this.cita.fecha.getDate()).slice(-2);
      */
    ...
    ReprogramacionComponent.prototype.goBack = function () {
        this._location.back();
        //	let _backUrl = 'servicios';
        //this.router.navigateByUrl(_backUrl);
    };
    ReprogramacionComponent.prototype.sinEmpleado = function () {
        var sinEmpleado = false;
        if (this.serviciosCita.length < 1) {
            sinEmpleado = true;
        }
    ...
    ReprogramacionComponent.prototype.getTotal = function () {
        var total = 0;
        this.serviciosCita.forEach(function (item) {
            item.precioFinal = item.precio;
            total += item.precio;
    ...
    ReprogramacionComponent.prototype.procesarData = function (tiemp) {
        if (tiemp === void 0) { tiemp = null; }
        return __awaiter(this, void 0, void 0, function () {
            var valueE, value, darr, indexx, d, diaS, fechaSeleccionada, _i, _a, item, dataEmpleados;
            return __generator(this, function (_b) {
    ...
    ReprogramacionComponent.prototype.getHorasFormat = function (dat) {
        var ww = Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(dat, 'h:mm a', 'es');
        return ww;
    };
    ReprogramacionComponent.prototype.getHorasFormat2 = function (dat) {
        //console.log(dat);
        var dat2 = this.fechaSeleccionadaN + ' ' + dat;
        var ww = Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(dat2, 'h:mm a', 'es');
        return ww;
    };
    ReprogramacionComponent.prototype.changeTime = function (time) {
        console.log(time);
        var tiempo = time.value.split(' ')[1];
        this.procesarData(tiempo);
    };
    ReprogramacionComponent.prototype.delayedLog = function (item) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.authService.getHorasDispo(item).subscribe(function (data) {
                //  console.log(data);
    ...
    ReprogramacionComponent.prototype.delayedLog2 = function (item) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.authService.getEmpleadosDisponibles(item).subscribe(function (data) {
                //   console.log(data);
    ...
    ReprogramacionComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'm-reprogramacion',
            template: __webpack_require__(/*! ./reprogramacion.component.html */ "./src/app/content/pages/components/reprogramacion/reprogramacion.component.html"),
            styles: [__webpack_require__(/*! ./reprogramacion.component.scss */ "./src/app/content/pages/components/reprogramacion/reprogramacion.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _core_auth_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["Location"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], ReprogramacionComponent);
    return ReprogramacionComponent;
}());
...
var ReviewComponent = /** @class */ (function () {
    function ReviewComponent(authService, cdr) {
        this.authService = authService;
        this.cdr = cdr;
        this.loadingScreen = false;
        this.fechas = {};
    ...
    ReviewComponent.prototype.changeDate2 = function () {
        this.fechas.fin = undefined;
    };
    ReviewComponent.prototype.changeDate1 = function () {
        var _this = this;
    ...
    ReviewComponent.prototype.responderCom = function (item) {
        var _this = this;
        console.log(item);
        this.loadingScreen = true;
...
/*!***************************************************************************!*\
  !*** ./src/app/content/pages/components/servicios/servicios.component.ts ***!
  \***************************************************************************/
/*! exports provided: CallbackPipe, ServiciosComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ServiciosComponent = /** @class */ (function () {
    function ServiciosComponent(authService, cdr) {
        var _this = this;
        this.authService = authService;
        this.cdr = cdr;
        /*
        ...
        */
        ...
        this.displayedColumns = ['nombre', 'precioOferta', 'fechaCaducidad', 'estado'];
        this.displayedColumns5 = ['nombre', 'precioTotal', 'fechaVencimiento', 'estado'];
        ...
        this.filterUser = function (user) {
            ...
            return user.nombre.toLowerCase().includes(_this.textFilter.toLowerCase());
        };
        var retrievedObject = JSON.parse(localStorage.getItem('userADby2as'));
        this.idCentro = retrievedObject.idCentro;
        console.log(this.idCentro);
    ...
    ServiciosComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getPaquetes({ idCentro: this.idCentro })
            .subscribe(function (data) {
            console.log(data);
            _this.ofertas = data.ofertas;
            _this.paquetes = data.paquetes;
            _this.ELEMENT_DATA = data.ofertas;
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](_this.ELEMENT_DATA);
            _this.dataSource5 = new _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"](data.paquetes);
            _this.dataSource.paginator = _this.paginator;
            _this.dataSource5.paginator = _this.paginator5;
            _this.cdr.detectChanges();
        }, function (err) {
            console.log('someError');
            alert('Ups! Algo ha salido mal');
    ...
    ServiciosComponent.prototype.cambiarPaquete = function (estado, id) {
        var _this = this;
    ...
    ServiciosComponent.prototype.cambiarOferta = function (estado, id) {
        var _this = this;
        console.log(estado, id);
        this.loadingScreen = true;
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatPaginator"]),
        __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatPaginator"])
    ], ServiciosComponent.prototype, "paginator5", void 0);
...
var StaffComponent = /** @class */ (function () {
    function StaffComponent(authService, cdr) {
        this.authService = authService;
        this.cdr = cdr;
        this.horarioHoras = [
            { 'text': '12:00 AM', 'valor': '00:00:00' },
    ...
    StaffComponent.prototype.getHoras = function (hora) {
        return Math.floor(hora / 60);
    };
    StaffComponent.prototype.guardarHorario = function () {
        console.log(Object.values(this.diasSemana));
        //this.serviciosValues = Object.values(data.servicios);
        var dataEnv = { horario: Object.values(this.diasSemana), idEmpleado: this.selected };
        //dataEnv.horario = Object.values(this.diasSemana);
    ...
    StaffComponent.prototype.OnChange = function ($event, i) {
        console.log($event);
        console.log(i);
        var estadoC = $event.checked ? 1 : 0;
        this.authService.cambiarEstadoSE({ idEmpleado: this.selected, idServicio: i.idServicio, estado: estadoC })
...
var routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: _components_agregarservicio_agregarservicio_component__WEBPACK_IMPORTED_MODULE_16__["AgregarservicioComponent"]
            },
            {
                path: 'editservicio',
            ...
            {
                path: 'agregarpaquete',
                component: _components_agregarpaquete_agregarpaquete_component__WEBPACK_IMPORTED_MODULE_17__["AgregarpaqueteComponent"]
            },
            {
                path: 'agregaroferta',
