...
var AsideLeftComponent = /** @class */ (function () {
    ...
    AsideLeftComponent.prototype.getRo = function (item) {
        var retrievedObject = JSON.parse(localStorage.getItem('userADby2as'));
...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(router, authService, sanitizer, cdr) {
        this.router = router;
        this.authService = authService;
        this.sanitizer = sanitizer;
        this.cdr = cdr;
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http, tokenStorage, util) {
        ...
        this.util = util;
        this.API_URL = 'https://centro.yourbeauty.com.pa:8282';
        this.API_ENDPOINT_LOGIN = '/loginNC2';
    ...
    AuthenticationService.prototype.nuevoUsuarioNC = function (dataUser) {
        return this.http.post(this.API_URL + '/nuevoUsuarioNC', dataUser);
    };
    AuthenticationService.prototype.addStaffNC = function (staff) {
        return this.http.post(this.API_URL + '/addStaffNC', staff);
    };
    AuthenticationService.prototype.cambiarServicioCitaNCREPRO = function (staff) {
        return this.http.post(this.API_URL + '/cambiarServicioCitaNCREPRO', staff);
    };
    AuthenticationService.prototype.addInfoCentroNC = function (horario) {
...
module.exports = __webpack_require__(/*! /Users/jose/Documents/beyouApp/consolaMetronic/test/src/main.ts */"./src/main.ts");
